...
namespace CrossPlatformLibrary.Camera
{
    public class Media : IMedia
    {
        ...
        public Media()
        {
            ...
            try
            {
                this.IsCameraAvailable = Microsoft.Devices.Camera.IsCameraTypeSupported(CameraType.Primary) || Microsoft.Devices.Camera.IsCameraTypeSupported(CameraType.FrontFacing);
            }
            catch (Exception ex)
            {
